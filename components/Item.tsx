        ...
        <main className="pb-16 pt-8">
            <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="px-4 sm:px-0">
                    <h2 className="text-lg font-medium text-gray-900">Bid to <span className="font-bold text-purple-600">Rolex</span></h2>
                </div>
                <h4 className="text-sm text-gray-400">Current price is <span className="font-semibold">$100.00</span></h4>
                <div className="mt-4">
